        ...
        const updatedDebt = await prisma.$transaction(async (transactionPrisma) => {
            ...
            const updatedDebt = await transactionPrisma.debt.update({
                ...
                data: {
                    ...
                    remainingAmount: totalAmount, // Update remaining amount
            ...
            const newBalance = account.balance - (digitalAmt - (existingDebt.digitalAmount || 0));
            const newCashBalance = account.cashBalance - (cashAmt - (existingDebt.cashAmount || 0));
